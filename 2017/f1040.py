...
class F1040(Form):
    ...
    BRACKET_LIMITS = [
        ...
        [9325, 37950, 76550, 116675, 208350, 235350],   # SEPARATE
    ...
    def deduction_for_exemptions(f, status):
        THRESH = [261500, 313800, 156900, 287650]
        w = {}
        ...
        if w['3'] <= w['4']:
            return w['2']
        w['5'] = w['3'] - w['4']
        threshold = 61250 if status == FilingStatus.SEPARATE else 61250
        if w['5'] >= threshold:
            return 0
