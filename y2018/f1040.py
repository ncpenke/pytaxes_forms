...
#   dividends (optional)
#   qualified_dividends (optional)
#   business income (optional)
#   capital_gain_dist (optional)

class F1040(Form):
    STD_DED = [12000, 24000, 12000, 18000]
    ...
    CAPITAL_GAINS_BRACKET_LIMITS = [
        [77200 * 0.5, 425800],
        [77200, 479000],
        [77200 * 0.5, 479000 * 0.5],
        [51700, 452400]
    ]
    SS_MAX = 7960.80
    ...
    def __init__(f, inputs={}):
        ...
        if sd.mustFile():
            f['13'] = sd['21'] or sd['16']
            f.comment['13'] = "Capital gain or loss"
        else:
        ...
        elif not 'do_not_itemize_deductions' in inputs:
            file_sched_a = sa['29'] > std
        sa.must_file = file_sched_a
        if file_sched_a:
    ...
    def div_cap_gain_tax_worksheet(f, inputs, sched_d):
        ...
        w['6'] = max(0, w['4'] - w['5'])
        w['7'] = max(0, w['1'] - w['6'])
        w['8'] = f.CAPITAL_GAINS_BRACKET_LIMITS[inputs['status']][0]
        w['9'] = min(w['1'], w['8'])
        w['10'] = min(w['7'], w['9'])
        w['11'] = w['9'] - w['10']
        w['12'] = min(w['1'], w['6'])
        w['13'] = w['11']
        w['14'] = w['12'] - w['13']
        w['15'] = f.CAPITAL_GAINS_BRACKET_LIMITS[inputs['status']][1]
        w['16'] = min(w['1'], w['15'])
        w['17'] = w['7'] + w['11']
